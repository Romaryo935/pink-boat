...
class StaticDetails extends StatefulWidget {
  _StaticDetails createState() => _StaticDetails();
}

class _StaticDetails extends State<StaticDetails> {
                ...
                children: <Widget>[
                  Stack(
                    children: <Widget>[
                      Container(
                        child: Image.network(
                            hospitalItem["test_center"]["medical_org"]
                                ["pic_url"],
                            fit: BoxFit.fitWidth),
                ...
                Container(
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      ...
                      title: Text("Phone"),
                      subtitle: Text(hospitalItem["test_center"]["medical_org"]
                              ["phone"]["phone"]
                          .toString()), //
                    ),
                    ...
                    ListTile(
                      ...
                      subtitle: Text("From " +
                          hospitalItem["test_center"]["medical_org"]["from"] +
                          " To " +
                          hospitalItem["test_center"]["medical_org"]["to"] +
