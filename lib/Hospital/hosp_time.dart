...
import 'package:flutterapp/Hospital/hospreservation.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'hospconfirm.dart';
...
class HospTime extends StatefulWidget {
  @override
  _HospTimeState createState() => _HospTimeState();
}

class _HospTimeState extends State<HospTime> {
      ...
      setState(() {
        ...
        abovedate=new DateTime (lol.year,lol.month,lol.day,9,00);
            ...
            context,new MaterialPageRoute(
                builder: (context) =>Hospconfirm(),settings: RouteSettings(arguments: abovedate,)));});
