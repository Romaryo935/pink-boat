...
var byteimaged;
pw.Document newpff;
class ReportDetails1 extends StatefulWidget {
  @override
  _ReportDetails1State createState() => _ReportDetails1State();
}


class _ReportDetails1State extends State<ReportDetails1> {
    ...
    SizedBox(height:15,),
      ...
      SizedBox(height:145,),
       Row(mainAxisAlignment: MainAxisAlignment.start,children:<Widget>[ Column (
        mainAxisAlignment: MainAxisAlignment.start,
        children: <Widget>[
          new Text ("   Medical Analysis Lab Name:      ",style: TextStyle(color: Colors.black,fontSize: 14)),
          new Text ("   "+screeningresultdetails["medicalAnalysisLab_code"]["medical_org"]["name"]+"      ",style: TextStyle(color: Colors.grey,fontSize: 14,),),
        ],
      ),
        ]),
          Row(mainAxisAlignment: MainAxisAlignment.start,children:<Widget>[ Column (
...
return <pw.Widget>  [
  ...
  pw.Container(child: pw.Image(image3,height:50,width:50),),
       pw.SizedBox(width: 10),
  pw.Container(child: pw.Image(image4,height:50,width:50),),
       ]),
     ...
     pw.SizedBox(height:50,),
      ...
      pw.SizedBox(height:200,),
       pw.Row(mainAxisAlignment: pw.MainAxisAlignment.start,children:<pw.Widget>[ pw.Column (
        mainAxisAlignment: pw.MainAxisAlignment.start,
        children: <pw.Widget>[
          pw.Text ("   Medical Analysis Lab Name:      ",style: pw.TextStyle(color: PdfColors.black,fontSize: 14)),
          pw.Text (screeningresultdetails["medicalAnalysisLab_code"]["medical_org"]["name"]+"      ",style: pw.TextStyle(color: PdfColors.grey,fontSize: 14,),),
        ],
      ),
        ]),
          pw.Row(mainAxisAlignment: pw.MainAxisAlignment.start,children:<pw.Widget>[ pw.Column (
