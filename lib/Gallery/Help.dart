...
class _Help extends State<Help> {
  ...
  List<ItemModel> prepareData = <ItemModel>[
    ItemModel(
        header: 'About Us......',
        bodyModel: BodyModel(answer: '22', quantity: _video())),
    // no video
    ItemModel(
        header: 'How to create account in this application? ',
        bodyModel: BodyModel(answer: 'asfcaec', quantity: _video())),
    ItemModel(
        header: 'How to book a hospital visit?',
        bodyModel: BodyModel(answer: '22', quantity: _video2())),

    ItemModel(
        header: 'How to book a screening test center reservation?',
        bodyModel: BodyModel(answer: '22', quantity: _video3())),
    ItemModel(
        header: 'How to see the nearest awareness campaign?',
        bodyModel: BodyModel(answer: '22', quantity: _video4())),
    ItemModel(
        header: 'How to see my booked reservations?',
        bodyModel: BodyModel(answer: '22', quantity: _video5())),
    ItemModel(
        header: 'How to check my test result ?',
        bodyModel: BodyModel(answer: '22', quantity: _video6())),
    ItemModel(
        header: 'How to change my password?',
        bodyModel: BodyModel(answer: '22', quantity: _video7())),
    ItemModel(
    ...
    ItemModel(
        ...
        bodyModel: BodyModel(answer: '22', quantity: _video8())),
    ItemModel(
        header: 'How to change my display picture?',
        bodyModel: BodyModel(answer: '22', quantity: _video8())),
    // ItemModel(
    //     header: '', bodyModel: BodyModel(answer: '22', quantity: _video1())),
    // ItemModel(
    //     header: '', bodyModel: BodyModel(answer: '22', quantity: _video1())),
    // ItemModel(
    //     header: '', bodyModel: BodyModel(answer: '22', quantity: _video1())),
