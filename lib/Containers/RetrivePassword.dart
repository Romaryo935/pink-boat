...
import 'package:flutterapp/Containers/showpinbox.dart';
...
class _RtrivePassword extends State<RetrivePassword> {
        ...
        child: Column(
          children: <Widget>[
            Container(
                ...
                child: Text(
                  "We will help you to change your password by send code to your email :))",
                  style: TextStyle(
          ...
          Form(
              ...
              child: Column(children: <Widget>[
                ...
                Container(
                    ...
                    width: MediaQuery.of(bc).size.width * (4 / 5),
                    height: 45,
  ...
  static void handleSendPassword(String mail, BuildContext bc) async {
    ...
    if (response.toString().contains("200")) {
      pr.dismiss();
      showAlertDialogSent(bc, "code sent successfully");
    } else {
      pr.dismiss();
