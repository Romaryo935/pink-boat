...
class Editconfirm extends StatefulWidget {
  @override
  _EditconfirmState createState() => _EditconfirmState();
}
     ...
     return Container(
        ...
        Column(
          children: <Widget>[
           ...
           Row(
          children:<Widget>[ 
            Text('Test Center Name: ',style: TextStyle(color: Colors.black,fontSize: 24,),),]),
          Row(
              children: <Widget>[
             Container(width:300,child:Text(testnameedit,style: TextStyle(color: Colors.grey,fontSize: 24,),),),
            ],),
               SizedBox(
                        height: 8,
                      ),
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.center,
                        children:<Widget>[
                          ...
                          FlatButton(onPressed:(){
                                Navigator.push(context,new MaterialPageRoute(builder: (context) => EditReservation(),));
...
"dateTime":finaldate.toString()+"Z"
       ...
       String response = await Apis.updatereservation(data);
       debugPrint(response);
