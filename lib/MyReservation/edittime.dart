  ...
  Row(
    ...
    child: Center(
     ...
     if(button1==Colors.green[200]){
      ...
      setState(() {
        ...
        abovedate=new DateTime (aa.year,aa.month,aa.day,9,00);
              Navigator.push(
            context,new MaterialPageRoute(
                builder: (context) =>Editconfirm(),settings: RouteSettings(arguments: abovedate,)));});
    ...
    child: Center(
     ...
     _destructor();
      setState(() {
        ...
        abovedate=new DateTime (aa.year,aa.month,aa.day,9,30);
              Navigator.push(
            context,new MaterialPageRoute(
                builder: (context) =>Editconfirm(),settings: RouteSettings(arguments: abovedate,)));});
    ...
    child: Center(
      ...
      setState(() {
        ...
        abovedate=new DateTime (aa.year,aa.month,aa.day,10,00);
              Navigator.push(
            context,new MaterialPageRoute(
                builder: (context) =>Editconfirm(),settings: RouteSettings(arguments: abovedate,)));});
    ...
    if(button4==Colors.green[200]){
      ...
      setState(() {
        ...
        abovedate=new DateTime (aa.year,aa.month,aa.day,10,30);
              Navigator.push(
            context,new MaterialPageRoute(
                builder: (context) => Editconfirm(),settings: RouteSettings(arguments: abovedate,)));});
    ...
    if(button5==Colors.green[200]){
      ...
      setState(() {
        ...
        abovedate=new DateTime (aa.year,aa.month,aa.day,11,00);
              Navigator.push(
            context,new MaterialPageRoute(
                builder: (context) => Editconfirm(),settings: RouteSettings(arguments: abovedate,)));});
    ...
    if(button6==Colors.green[200]){
      _destructor();
      setState(() {
        abovedate=new DateTime (aa.year,aa.month,aa.day,11,30);
              Navigator.push(
            context,new MaterialPageRoute(
                builder: (context) =>Editconfirm(),settings: RouteSettings(arguments: abovedate,)));});
    ...
    if(button7==Colors.green[200]){
      ...
      setState(() {
        ...
        abovedate=new DateTime (aa.year,aa.month,aa.day,12,00);
              Navigator.push(
            context,new MaterialPageRoute(
                builder: (context) =>Editconfirm(),settings: RouteSettings(arguments: abovedate,)));});
    ...
    if(button8==Colors.green[200]){
      ...
      setState(() {
        ...
        abovedate=new DateTime (aa.year,aa.month,aa.day,12,30);
              Navigator.push(
            context,new MaterialPageRoute(
                builder: (context) => Editconfirm(),settings: RouteSettings(arguments: abovedate,)));});
    ...
    if(button9==Colors.green[200]){
      ...
      setState(() {
        ...
        abovedate=new DateTime (aa.year,aa.month,aa.day,13,00);
              Navigator.push(
            context,new MaterialPageRoute(
                builder: (context) => Editconfirm(),settings: RouteSettings(arguments: abovedate,)));});
 ...
 Row(
    ...
    if(button10==Colors.green[200]){
      ...
      setState(() {
        ...
        abovedate=new DateTime (aa.year,aa.month,aa.day,13,30);
              Navigator.push(
            context,new MaterialPageRoute(
                builder: (context) => Editconfirm(),settings: RouteSettings(arguments: abovedate,)));});
    ...
    if(button11==Colors.green[200]){
      ...
      setState(() {
        ...
        abovedate=new DateTime (aa.year,aa.month,aa.day,14,00);
              Navigator.push(
            context,new MaterialPageRoute(
                builder: (context) =>Editconfirm(),settings: RouteSettings(arguments: abovedate,)));});
    ...
    if(button12==Colors.green[200]){
      ...
      setState(() {
        ...
        abovedate=new DateTime (aa.year,aa.month,aa.day,14,30);
              Navigator.push(
            context,new MaterialPageRoute(
                builder: (context) => Editconfirm(),settings: RouteSettings(arguments: abovedate,)));});
  ...
  if(button13==Colors.green[200]){
     ...
     setState(() {
        ...
        abovedate=new DateTime (aa.year,aa.month,aa.day,15,00);
              Navigator.push(
            context,new MaterialPageRoute(
                builder: (context) => Editconfirm(),settings: RouteSettings(arguments: abovedate,)));});
...
_handlereq() async {
 var data=  {
"token":Apis.mytoken,
"testCenter_id": modidedit,
"date":aa.year.toString()+"-"+aa.month.toString()+"-"+aa.day.toString()+" 00:00:00Z"
};
       dynamic response = await  Apis.showrtest(data);
      this.originalShowtest = response;
      setState(() {
